...
For information on how to created unit tests, please see the [Automated Tests](https://github.com/dpjl/joplin/blob/dev/readme/dev/index.md#automated-tests) documentation.
