...
In the **terminal application**, in [command-line mode](https://github.com/dpjl/joplin/blob/dev/readme/apps/terminal.md#command-line-mode), type `import /path/to/file.enex`. This will import the notes into a new notebook named after the filename.
...
In the **terminal application**, in [command-line mode](https://github.com/dpjl/joplin/blob/dev/readme/apps/terminal.md#command-line-mode):
