...
1. On your first device (eg. on the desktop application), go to the Encryption  [Configuration screen](https://github.com/dpjl/joplin/blob/dev/readme/apps/config_screen.md) and click "Enable encryption"
...
For a more technical description, mostly relevant for development or to review the method being used, please see the [Encryption specification](https://github.com/dpjl/joplin/blob/dev/readme/dev/spec/e2ee.md).