...
There is documentation of the plugin API along with documentation on plugin development. Check the [Joplin API Overview](https://github.com/dpjl/joplin/blob/dev/readme/api/index.md) page for these items.
