...
describe('build-release-stats', () => {
	...
	it('should replace GitHub internal link', async () => {
		const testCases = [
			[
				'(15ce5cd)',
				'([15ce5cd](https://github.com/dpjl/joplin/commit/15ce5cd))',
			],
			[
				'(#8532 by Henry Heino)',
				'([#8532](https://github.com/dpjl/joplin/issues/8532) by Henry Heino)',
			],
			[
				'([15ce5cd](https://github.com/dpjl/joplin/commit/15ce5cd))',
				'([15ce5cd](https://github.com/dpjl/joplin/commit/15ce5cd))',
			...
			[
				...
				'list ([#8825](https://github.com/dpjl/joplin/issues/8825)) ([#8194](https://github.com/dpjl/joplin/issues/8194) by [@CptMeetKat](https://github.com/CptMeetKat))',
			],
			[
