...
${actual}`);
	...
	test.each([
		...
		[
			'[synchronisation set to Joplin Cloud](https://github.com/dpjl/joplin/blob/dev/readme/apps/sync/joplin_cloud.md)',
			'[synchronisation set to Joplin Cloud](/help/apps/sync/joplin_cloud)',
		],
		[
			'The notes can be securely [synchronised](https://github.com/dpjl/joplin/blob/dev/readme/apps/sync/index.md) using [end-to-end encryption](https://github.com/dpjl/joplin/blob/dev/readme/apps/sync/e2ee.md)',
		...
		[
			'[Configuration screen](https://github.com/dpjl/joplin/blob/dev/readme/apps/config_screen.md) [Configuration screen](https://github.com/dpjl/joplin/blob/dev/readme/apps/config_screen.md)',
			'[Configuration screen](/help/apps/config_screen) [Configuration screen](/help/apps/config_screen)',
		],
		[
			'In [command-line mode](https://github.com/dpjl/joplin/blob/dev/readme/apps/terminal.md#command-line-mode), type `import --format md /path/to/file.md`',
